...
app.add_middleware(
	CORSMiddleware,
	allow_origins=["http://localhost:4173", "http://localhost:5173", "http://172.16.104.213:4173", "http://localhost:5174", "http://localhost:3000", "http://0.0.0.0:3000", "http://192.168.1.29:3000"],
